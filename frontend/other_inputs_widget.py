...
class OtherInputsWidget(QFrame):
    ...
    def create_widgets(self):
        ...
        self.power_progress_groupbox = QGroupBox("Power and Progress Inputs")
        ...
        power_progress_layout.addWidget(self.pot_checkbox,0,0,1,2)
        power_progress_layout.addWidget(self.newb_progress_checkbox,1,0,1,2)
        power_progress_layout.addWidget(self.pro_progress_checkbox,2,0,1,2)
        power_progress_layout.addWidget(self.newb_power_checkbox,3,0,1,2)
        power_progress_layout.addWidget(self.pro_power_checkbox,4,0,1,2)
        power_progress_layout.addWidget(self.soul_power_checkbox,5,0,1,2)
        power_progress_layout.addWidget(self.adv_item_label,0,2)
        power_progress_layout.addWidget(self.adv_item_entry,0,3)
        power_progress_layout.addWidget(self.max_stage_label,1,2)
        power_progress_layout.addWidget(self.max_stage_entry,1,3)
        power_progress_layout.addWidget(self.syn_perks_label,2,2)
        power_progress_layout.addWidget(self.syn_perks_entry,2,3)
        power_progress_layout.addWidget(self.pomos_level_label,3,2)
        power_progress_layout.addWidget(self.pomos_level_entry,3,3)
        ...
        script_info_layout.addWidget(self.save_settings_button,3,0,1,2)
        script_info_layout.addWidget(self.load_settings_button,4,0,1,2)
